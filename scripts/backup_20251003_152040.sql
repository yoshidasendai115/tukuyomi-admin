...
CREATE TABLE IF NOT EXISTS "public"."message_threads" (
    ...
    CONSTRAINT "message_threads_thread_type_check" CHECK (("thread_type" = ANY (ARRAY['application'::"text", 'broadcast'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."review_deletion_requests" (
    ...
    "updated_at" timestamp with time zone DEFAULT "now"(),
    "processed_at" timestamp with time zone,
    CONSTRAINT "review_deletion_requests_status_check" CHECK ((("status")::"text" = ANY (ARRAY[('pending'::character varying)::"text", ('approved'::character varying)::"text", ('rejected'::character varying)::"text"])))
);
...
CREATE INDEX "idx_broadcast_recipients_broadcast_message_id" ON "public"."broadcast_recipients" USING "btree" ("broadcast_message_id");
...
CREATE INDEX "idx_cast_profiles_nearest_area_id" ON "public"."cast_profiles" USING "btree" ("nearest_station_id");
...
CREATE INDEX "idx_guest_profiles_nearest_area_id" ON "public"."guest_profiles" USING "btree" ("nearest_station_id");
...
ALTER TABLE ONLY "public"."cast_profiles"
    ADD CONSTRAINT "cast_profiles_nearest_station_id_fkey" FOREIGN KEY ("nearest_station_id") REFERENCES "public"."stations"("id");
...
ALTER TABLE ONLY "public"."guest_profiles"
    ADD CONSTRAINT "guest_profiles_nearest_station_id_fkey" FOREIGN KEY ("nearest_station_id") REFERENCES "public"."stations"("id");
